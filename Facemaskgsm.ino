...
SoftwareSerial message(2, 3); //(rx, tx) 
...
void setup()
{
  Serial.begin(115200);  //iot (TX0-RX)// nodemcu 4th pin
  ...
  if (Hour == 8 && Min == 00 && Sec <= 15)
  {
    ...
    switch (level)
    {
      case 5 ...9:
        ...
        send_sms("9176083209", "Bin is FULL, disinfection ongoing");
        break;
      case 10 ...12:
        lcd.setCursor(0, 0);
        lcd.print("Message sending");
        send_sms("9176083209", "Bin is 50% FILLED, second LED activated");
        break;
      case 13 ...17:
        lcd.setCursor(0, 0);
        lcd.print("Message sending");
        send_sms("9176083209", "Bin is EMPTY");
        break;
    }
  }
